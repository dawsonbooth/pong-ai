...
parser.add_argument("-a1", "--agent1", type=str, choices=["player", "basic", "q-learning",], help="Type of player for the left paddle")
parser.add_argument("-a2", "--agent2", type=str, choices=["player", "basic", "q-learning",], help="Type of player for the right paddle")
